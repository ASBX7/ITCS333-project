...
<html lang="en">
  ...
  <header>
    ...
    <div class="container">
      <a href="department.php?department=Information System (IS)">
        <div class="card">
      ...
      <a href="department.php?department=Computer Science (CS)">
        <div class="card">
          <div class="icon"><i class="fa-solid fa-desktop"></i></div>
          <h1>CS</h1>
        </div></a
      ...
      <a href="department.php?department=Computer Engineering (CE)">
        <div class="card">
        <div class="icon"><i class="fa-solid fa-desktop"></i></div>
          <h1>CE</h1>
        </div></a
